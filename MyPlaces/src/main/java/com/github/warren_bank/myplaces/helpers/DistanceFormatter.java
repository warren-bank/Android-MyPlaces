package com.github.warren_bank.myplaces.helpers;
...
public final class DistanceFormatter {
    ...
    private static final String UNIT_METER     = "meters";  // "m"
    private static final String UNIT_KILOMETER = "km";      // "km"
    private static final String UNIT_FEET      = "feet";    // "ft"
    private static final String UNIT_MILE      = "miles";   // "mi"
    private static final String UNIT_CLOSE_RT  = "here";    // "now"

    public static enum DistanceUnits { MILES, KILOMETERS }
     ...
     * @return distance string formatted according to the rules of the formatter.
     */
    public static String format(int distanceInMeters, boolean realTime, Locale locale, DistanceUnits units) {
    ...
    private static String formatDistanceOverTenMeters(int distanceInMeters) {
        return String.format(Locale.getDefault(), "%s %s", distanceInMeters, UNIT_METER);
    }

    private static String formatShortMeters(int distanceInMeters, boolean realTime) {
        if (realTime) {
            return UNIT_CLOSE_RT;
        } else {
            return formatDistanceOverTenMeters(distanceInMeters);
        }
    }
    ...
    private static String formatDistanceInKilometers(int distanceInMeters) {
        ...
        return String.format(Locale.getDefault(), "%s %s", value, UNIT_KILOMETER);
    }
    ...
    private static String formatDistanceOverTenFeet(double distanceInFeet) {
        ...
        return String.format(Locale.getDefault(), "%d %s", roundedDistanceInFeet, UNIT_FEET);
    }
